...
public class ChoosePhotoSourceFragment extends TalkletFragment implements ChoosePhotoContract.View{
...
//            galleryIntent.putExtra(MediaStore.EXTRA_OUTPUT, imageUri);
            getActivity().startActivityForResult(galleryIntent, REQUEST_CODE_PICK_FROM_GALLERY);
        }
...
//        values.put(MediaStore.Images.Media.DESCRIPTION, PROFILE_PHOTO_DESCRIPTION);
            imageUri = getContext().getContentResolver()
                    .insert(
                            MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);
            Intent cameraIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
            cameraIntent.putExtra(MediaStore.EXTRA_OUTPUT, imageUri);
            getActivity().startActivityForResult(cameraIntent, REQUEST_CODE_TAKE_PHOTO);
        }
    }
