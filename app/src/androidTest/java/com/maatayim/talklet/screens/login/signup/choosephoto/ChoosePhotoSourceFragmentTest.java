...
@LargeTest
public class ChoosePhotoSourceFragmentTest {

    @Rule
    public ActivityTestRule<TestActivity> fragmentActivityTestRule = new ActivityTestRule<>(TestActivity
            .class);
    private ChoosePhotoSourceFragment fragment;


    @Before
    public void setUp() throws Exception {
        fragment = new ChoosePhotoSourceFragment();
    ...
    public void confirmImageExists(){
        Espresso.onView(ViewMatchers.withId(R.id.gallery_button))
